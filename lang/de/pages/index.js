export default {
  ...
  environmentCounterUpNumbers: [
    {
      endVal: 20,
      unit: 'Mt',
      desc: `Fisch werden jährlich zu Fischmehl verarbeitet.`,
    },
    {
      endVal: 19,
      unit: '%',
  ...
  hermetiaCounterUpNumbers: [
    ...
    },
    {
      endVal: 200,
      unit: 'M$',
      desc: `wurden weltweit in den letzten 5 Jahren in die Entwicklung von Insekten-Zucht-Technologien investiert.`,
    },
  ],
  processSection: {
