export default {
  ...
  index: {
    ...
    numbersAndFactsHeading: 'Zahlen und Fakten',
    environmentCounterUpNumbers: [
      {
        endVal: 20,
        unit: 'Mt',
        desc: `Millionen Tonnen Fisch werden jährlich zu Fischmehl verarbeitet.`,
      },
      {
        endVal: 19,
        unit: '%',
        desc: `aller Hunde leiden an einer Protein-induzierten Futtermittel-Intoleranz.`,
      },
      {
        endVal: 60,
        unit: '%',
        desc: `der natürlichen Ernährung von Forellen besteht aus Insekten.`,
      },
    ],
    solutionSection: {
    ...
    hermetiaCounterUpNumbers: [
      {
        endVal: 90,
        unit: '%',
        desc: `der Proteine in ihrem Futter kann Hermetia Illucens zu Biomasse umwandeln.`,
      },
      {
        endVal: 1000,
        unit: 'kg',
        desc: `Insektenmehl können wir auf einem m² jährlich produzieren.`,
      },
      {
        endVal: 200,
        unit: 'M$',
        desc: `Millionen Dollar wurden weltweit in den letzten 5 Jahren in die Entwicklung von Insekten-Zucht-Technologien investiert.`,
      },
    ],
    processSection: {
    ...
    slider:  [
      {
        ...
        title: 'Innovative Futtermittel',
        desc: 'für eine artgerechte und umweltverträgliche Nutztierhaltung',
      },
      {
        src: 'haustiere.jpg',
        title: 'Natürliche Nahrungsquelle',
        desc: 'verträgliche Futtermittel für Nutz- und Haustiere',
      },
      {
        src: 'hand-in-futtermittel.jpg',
        title: 'Nachhaltige Lebensmittel- produktion',
  ...
  footer: {
    ifYouHaveQuestions: 'Bei Fragen',
    contact: 'Kontaktieren',
    us: 'Sie uns!',
    toContact: 'Kontakt herstellen',
